                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <button
                        ...
                        className="p-2 bg-blue-500 hover:bg-blue-600 text-white rounded-full shadow-md transition-colors focus:outline-none"
                        aria-label="Facebook button"
                      >
                       <a href="https://www.facebook.com/"><FaFacebookF className="w-4 h-4" /></a> 
                      </button>

                      {/* "add link" moved to right */}
                      <div className="ml-auto">
                        <a
                          href="https://www.facebook.com/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="f hover:underline font-bold text-gray-950"
                        >
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <button
                        type="button"
                        className="p-2 bg-pink-500 hover:bg-pink-600 text-white rounded-full shadow-md transition-colors focus:outline-none"
                        aria-label="Instagram button"
                      >
                       <a href="https://www.instagram.com/"><FaInstagram className="w-4 h-4" /></a> 
                      </button>
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <button
                        type="button"
                        className="p-2 bg-sky-500 hover:bg-sky-600 text-white rounded-full shadow-md transition-colors focus:outline-none"
                        aria-label="Telegram button"
                      >
                        <a href="https://web.telegram.org/a/"><FaTelegramPlane className="w-4 h-4" /></a>
                      </button>
